...
const setMainImgByHash = (req, res, next) => {
  ...
  const newLink = path.join(pathparts.link, pathparts.mainfilename); // LinkOrdner+/+mainfilename 
  // const newLink = path.join(pathparts.mainfilename); // LinkOrdner+/+mainfilename 
